 ...
 */
@AnalyzeClasses(packages = "io.unbyte.sandbox", importOptions = ImportOption.DoNotIncludeTests.class)
public class HexagonalArchitectureTest {
     ...
     */
    @ArchTest
    static final ArchRule domainIsPure = ArchRuleDefinition.noClasses()
     ...
     */
    @ArchTest
    static final ArchRule domainShouldNotHaveSpringAnnotations = ArchRuleDefinition.noClasses()
            .that().resideInAPackage(DOMAIN)
     ...
     */
    @ArchTest
    static final ArchRule applicationShouldNotDependOnInfrastructure = ArchRuleDefinition.noClasses()
     ...
     */
    @ArchTest
    static final ArchRule controllersOnlyCallUseCases = ArchRuleDefinition.classes()
     ...
     */
    @ArchTest
    static final ArchRule infrastructureAdaptersShouldImplementPorts = ArchRuleDefinition.classes()
            .that().resideInAPackage("..infrastructure.adapter..")
            .and().areNotInterfaces()
            .should().implement(io.unbyte.sandbox.application.port.Port.class)
     ...
     */
    @ArchTest
    static final ArchRule domainRepositoriesShouldBeInterfaces = ArchRuleDefinition.classes()
     ...
     */
    @ArchTest
    static final ArchRule applicationPortsShouldBeInterfaces = ArchRuleDefinition.classes()
     ...
     */
    @ArchTest
    static final ArchRule noPublicFields = ArchRuleDefinition.noFields()
            .that().areNotStatic()
            .and().areNotFinal()
            .should().bePublic();
     ...
     */
    @ArchTest
    static final ArchRule controllersShouldBeInWebPackage = ArchRuleDefinition.classes()
     ...
     */
    @ArchTest
    static final ArchRule sharedShouldNotDependOnOtherLayers = ArchRuleDefinition.noClasses()
     ...
     */
    @ArchTest
    static final ArchRule sharedUtilitiesShouldHavePrivateConstructors = ArchRuleDefinition.classes()
            .that().resideInAPackage("..shared.util..")
            .and().areNotInterfaces()
     ...
     */
    @ArchTest
    static final ArchRule noCyclicDependencies = com.tngtech.archunit.library.dependencies.SlicesRuleDefinition.slices()
