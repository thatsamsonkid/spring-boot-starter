        ...
        webTestClient
                ...
                .value(
                        response -> {
                            ...
                            assert response.getError()
                                    .getMessage()
                                    .contains("Validation failed for field testField");
        ...
        webTestClient
                ...
                .value(
                        response -> {
                            ...
                            assert response.getError()
                                    .getMessage()
                                    .contains("Entity TestEntity with ID test-id-123 not found");
