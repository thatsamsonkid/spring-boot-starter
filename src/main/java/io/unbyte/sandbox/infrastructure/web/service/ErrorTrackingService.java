...
public class ErrorTrackingService {
    ...
    public void trackError(ApplicationException exception) {
        ...
        logger.error(
                "Error tracked: {} - Layer: {} - Operation: {} - Correlation ID: {} - User ID: {}",
    ...
    public void trackError(Throwable throwable, String layer, String operation) {
        ...
        logger.error(
                "Generic error tracked: {} - Layer: {} - Operation: {} - Correlation ID: {} - User"
                        + " ID: {}",
     ...
     */
    private void recordErrorDetails(
            ApplicationException exception, String correlationId, String userId) {
