...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ErrorResponse>> handleApplicationException(
        ...
        logger.error("Application exception occurred: {} - Correlation ID: {} - User ID: {}", 
            ex.getErrorCode(), correlationId, userId, ex);
    ...
    public Mono<ResponseEntity<ErrorResponse>> handleGenericException(
        ...
        logger.error("Unexpected exception occurred - Correlation ID: {} - User ID: {}", 
            correlationId, userId, ex);
